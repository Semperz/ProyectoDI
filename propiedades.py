    ...
    def cargaOnePropiedad(self):
        try:
            ...
            if registro[11] == "0.0":
                ...
                var.ui.txtpreciopropven.setText("Propiedad en intercambio/alquiler")
                var.ui.txtpreciopropven.setStyleSheet('background-color:#FFC0CB;')
            ...
            if registro[10] == "0.0":
                ...
                var.ui.txtpreciopropalqui.setText("")
